...
def preprocess_file(file_path):
    ...
    pairs = list(zip(doctor_lines, patient_lines))
    print(pairs)
    ...
    return num_encoder_tokens, num_decoder_tokens, encoder_input_data, decoder_input_data, decoder_target_data, \
           target_features_dict, reverse_target_features_dict, max_decoder_seq_length, max_encoder_seq_length, input_features_dict


def build_train_models(num_encoder_tokens, num_decoder_tokens, encoder_input_data, decoder_input_data,
                       decoder_target_data):
    dimensionality = 256
    batch_size = 5
    epochs = 10
...
def decode_response(test_input):
    ...
    while not stop_condition:
        ...
        sampled_token = reverse_target_features_dict[int(sampled_token_index)]
...
class ChatBot:
    ...
    def start_chat(self):
        user_response = input("Hello there! Do you wanna chat?\n")
...
path = "Link to data"
num_encoder_tokens, num_decoder_tokens, encoder_input_data, decoder_input_data, decoder_target_data, \
target_features_dict, reverse_target_features_dict, max_decoder_seq_length, max_encoder_seq_length, input_features_dict = preprocess_file(path)
encoder_model, decoder_model = build_train_models(num_encoder_tokens, num_decoder_tokens, encoder_input_data,
